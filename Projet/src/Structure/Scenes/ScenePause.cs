...
public class ScenePause : Scene
{
    ...
    public ScenePause()
    {
        ...
        quitButton = new Button { Rect = new Rectangle((Raylib.GetScreenWidth() - i_ButtonWidht) /2, ((Raylib.GetScreenHeight() - i_ButtonHeight) /2 ) + i_ButtonHeight + 10, i_ButtonWidht, i_ButtonHeight), Text = "Quit", Color = Color.White };
    ...
    public override void Update()
    {
        ...
        else if (optionsButton.IsClicked || Raylib.IsKeyPressed(KeyboardKey.O))
        {
            ...
            GameState.RetrieveScene("options").b_FromMenu = false;
        }
